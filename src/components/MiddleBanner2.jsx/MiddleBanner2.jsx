...
const MiddleBanner2 = () => {
  return (
    <div
      className="mt-32 w-full min-h-[800px] bg-neutral-900/opacity-70 bg-no-repeat bg-cover relative"
      style={{
        backgroundImage: 'url(' + `${featuredImg}` + ')',
      }}
    >
      <div className="absolute top-0 left-0 w-full h-full bg-[#00000095]">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-5">
            ...
            <div className="w-full md:w-1/2">
              <div className="max-w-[604px]">
                <span className="text-white text-2xl font-normal font-['Inter'] leading-9">
                  March 20, 2023
                  <br />
                  WHERE CAN I GET SOME?
                  <br />
                </span>
                <p className="text-white text-base font-['Inter'] leading-[30px]">
